...
RUN apk add --no-cache gnupg && apk add --no-cache curl
...
# tadpole resource
RUN curl -fsSL https://sourceforge.net/projects/tadpoledbhub/files/1.7.x/1.7.4/tadpole.war -o /usr/local/tomcat/webapps/ROOT.war
